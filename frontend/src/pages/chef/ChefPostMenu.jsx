import { Camera, Leaf, Droplet, Flame, Zap, Plus, Info } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto py-6 font-sans pb-24 relative min-h-screen flex flex-col">
          ...
          <div className="md:col-span-2 space-y-8">
             <div className="bg-[#F2F0EA] rounded-[2rem] p-8">
                ...
                <div className="mb-6">
                   ...
                   <input type="text" placeholder="e.g. Autumnal Tuscan Harvest" className="w-full bg-white px-6 py-4 rounded-2xl border border-white focus:border-rust outline-none transition-colors shadow-sm text-ink font-medium" />
                </div>
                <div>
                   <label className="block text-[10px] font-bold text-ink-secondary uppercase tracking-widest mb-3">Detailed Description</label>
                   <textarea placeholder="Describe the inspiration, flavor profiles, and sensory journey of this menu..." className="w-full bg-white px-6 py-4 rounded-2xl border border-white focus:border-rust outline-none transition-colors shadow-sm text-ink min-h-[120px] resize-none"></textarea>
                </div>
             </div>
             ...
             <div>
                <div className="flex items-center justify-between mb-6">
                   ...
                   <div className="flex items-center gap-2 bg-[#F2F0EA] px-4 py-1.5 rounded-full border border-[#E5E1D6]">
                      ...
                      <span className="text-xs font-bold text-ink-secondary ml-2">KCAL</span>
                   </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                   {/* Starter */}
                   <div className="bg-[#Fdfcfb] rounded-[2rem] p-6 border border-[#E5E1D6] hover:border-rust/30 transition-colors shadow-sm h-48 flex flex-col justify-between">
                      ...
                      <div className="text-left mt-auto">
                         <p className="text-ink-tertiary text-sm">Dish Name</p>
                      </div>
                   </div>

                   {/* Main Course */}
                   <div className="bg-[#Fdf3e7] rounded-[2rem] p-6 border border-[#C0602F] shadow-md h-48 flex flex-col justify-between relative overflow-hidden">
                      ...
                      <div className="text-left mt-auto">
                         <p className="text-ink font-bold mb-2">Dish Name</p>
          ...
          <div className="space-y-6">
             ...
             <div className="bg-[#EBE9E1] rounded-[2rem] p-8 border border-[#E5E1D6]">
                ...
                <div className="flex bg-white rounded-full p-1 shadow-sm">
                  <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-full text-sm font-bold bg-[#3D6343] text-white shadow-sm">
                     <Leaf className="w-4 h-4"/> Veg
                  </button>
                  <button className="flex-1 flex items-center justify-center gap-2 py-3 rounded-full text-sm font-medium text-ink-secondary hover:text-ink">
                     Non-Veg
                  </button>
                </div>
             </div>
             ...
             <div className="bg-[#Fdf3e7] rounded-[2rem] p-8 border border-[#FBEAC8] shadow-md flex flex-col justify-center items-center text-center">
                ...
                <div className="flex items-start text-[#D98A52] mb-1">
                   ...
                   <input type="text" defaultValue="45.00" className="bg-transparent text-5xl font-black w-36 outline-none text-center" />
                </div>
      ...
      <div className="fixed bottom-0 left-0 md:left-64 right-0 bg-[#F9F8F6]/90 backdrop-blur-md border-t border-[#E5E1D6] py-4 px-8 flex items-center justify-between">
         <span className="text-xs font-bold text-ink-secondary tracking-widest">Save as Draft</span>
         <div className="flex items-center gap-4">
            ...
            <button className="px-6 py-2 rounded-full bg-[#302E2B] text-white text-sm font-bold shadow-md hover:bg-black transition-colors">Proceed to Review</button>
         </div>
      </div>
